...
export const faqControls = [
  ...
  { key: 'rowCount', type: 'slider', label: '问答行数', default: 4, min: 1, max: 5, step: 1, describe: '问答表的行数。' },
...
export default function FAQSlide(props) {
  ...
  const n = clampInt(p.rowCount, 1, 5);
      ...
      <Frame>
        ...
        {p.showMeta && (
          <footer className="ign-meta">
            ...
            <div className="r"><span className="ign-prog"><span className="track"><span className="fill" data-dashi-page-progress="" style={{ width: '48%' }} /></span> <span data-dashi-page-number="fraction" data-dashi-page-pad="1" data-dashi-page-total-pad="1" data-dashi-page-separator=" / " data-editable-skip="true"><b data-dashi-page-current="">39</b><span data-dashi-page-separator="true"> / </span><span data-dashi-page-total="">82</span></span></span></div>
          </footer>
        )}
      </Frame>
    </Slide>

      ...
      <Frame>
        ...
        {p.showMeta && (
          <footer className="ign-meta" style={{ marginTop: 24 }}>
            ...
            <div className="r"><span className="ign-prog"><span className="track"><span className="fill" data-dashi-page-progress="" style={{ width: '30%' }} /></span> <span data-dashi-page-number="fraction" data-dashi-page-pad="1" data-dashi-page-total-pad="1" data-dashi-page-separator=" / " data-editable-skip="true"><b data-dashi-page-current="">25</b><span data-dashi-page-separator="true"> / </span><span data-dashi-page-total="">82</span></span></span></div>
          </footer>
        )}
      </Frame>
    </Slide>
